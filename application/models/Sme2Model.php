...
class Sme2Model extends CI_Model {
    ...
    function getdatadetail($table,$intid){
      $this->db->select('a.*,
                        IFNULL(b.vcnama, "") as vcgedung,
                        IFNULL(c.vcnama, "") as vccell,
                        IFNULL(d.vcnama, "") as vcmodel',false);
      $this->db->from($table . ' as a');
      $this->db->join('m_gedung as b', 'b.intid = a.intgedung', 'left');
      $this->db->join('m_cell as c', 'c.intid = a.intcell', 'left');
      $this->db->join('m_models as d', 'd.intid = a.intmodel', 'left');
    ...
    function getteknologimesin2($intheader){
      $this->db->select('a.*,
                        IFNULL(b.vcnama, "") as vcteknologimesin,
    ...
    function getmodelteknologimesin($intheader){
      $this->db->select('a.*, b.intid as intprosesgroup, b.vcnama as vcprosesgroup, c.intid as intteknologimesin, c.vcnama as vcteknologimesin, "" as vcketerangan');
