...
class ProsesgroupModel extends CI_Model {
    ...
    function getdatadetail($table,$intid){
       $this->db->select('a.intid, a.vckode, a.vcnama, a.intstatus, a.dtupdate, ISNULL(b.vcnama, 0) as vcstatus, ISNULL(b.vcwarna, 0) as vcstatuswarna',false);
       $this->db->from($table . ' as a');
       $this->db->join('app_mstatus' . ' as b', 'a.intstatus = b.intstatus', 'left');
