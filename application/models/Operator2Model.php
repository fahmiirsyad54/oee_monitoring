...
class Operator2Model extends CI_Model {
   ...
   function getdatadowntime($date1,$date2,$intmesin,$intshift){
        ...
        $this->db->from('pr_downtime3 as a');
    ...
    function getkomponenct($intheader){
        ...
        return $this->db->get('m_models_komponen_ct2')->result();
    }
    ...
    function get_countmessage($date1, $date2, $intmesin, $intkaryawan){
        ...
        return $this->db->get('pr_pesan2')->num_rows();
    }
