...
<div id="modalCutting" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog">
		...
		<div class="modal-content modal-lg">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<select name="intkomponen" class="form-control" id="intkomponen1">
								<option data-ct="0" value="0">-Komponen-</option>
							</select>
					...
					<div class="col-md-2">
						<div class="form-group">
							<select name="vcartikel" class="form-control" id="vcartikel1">
								<option data-ct="0" value="">-- Artikel --</option>
							</select>
						</div>
					</div>
					...
					<div class="col-md-2">
						<div class="form-group">
							<select name="vcpo" class="form-control" id="vcpo1">
								<option data-ct="0" value="">--PO--</option>
							</select>
						</div>
					</div>
					...
					<div class="col-md-1">
						<div class="form-group">
							<input type="number" name="intreject" id="intreject1" onclick="setnum(11)" class="form-control" placeholder="">
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<select name="vcartikel" class="form-control" id="vcartikel2">
								<option data-ct="0" value="">-- Artikel --</option>
							</select>
						</div>
					</div>
					...
					<div class="col-md-1">
						<div class="form-group">
							<input type="number" name="intreject" id="intreject2" onclick="setnum(22)" class="form-control" placeholder="">
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<select name="vcartikel" class="form-control" id="vcartikel3">
								<option data-ct="0" value="">-- Artikel --</option>
							</select>
						</div>
					</div>
					...
					<div class="col-md-1">
						<div class="form-group">
							<input type="number" name="intreject" id="intreject3" onclick="setnum(33)" class="form-control" placeholder="">
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<select name="vcartikel" class="form-control" id="vcartikel4">
								<option data-ct="0" value="">-- Artikel --</option>
							</select>
						</div>
					</div>
					...
					<div class="col-md-1">
						<div class="form-group">
							<input type="number" name="intreject" id="intreject4" onclick="setnum(44)" class="form-control" placeholder="">
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	$(function () {
		...
		.done(function( data ) {
			...
			for (var i = 0; i < dataoutput.length; i++) {
				...
				_htmloutput += '<td>' + dataoutput[i].vcartikel + '</td>';
				_htmloutput += '<td>' + dataoutput[i].vcpo + '</td>';
			...
			if (dataoutput.length == 0) {
				_htmloutput = '<tr><td colspan="9" align="center">Data Not Found</td></tr>';
			}
			...
			for (var i = 0; i < listmodels.length; i++) {
				var _namamodels = listmodels[i].vcmodel;
				_htmlmodels += '<option value="' + listmodels[i].intmodel + '">' + _namamodels + '</option>';
			}
  ...
  //       }
		...
		// Model 2
		if ((intmodel2 > 0 || intkomponen2 > 0 || vcartikel2 != '' || vcpo2 != '') && (intpasang2 == '' || intpasang2 == 0 || intpasang2 < 0)) {
			swal({
					type: 'error',
		...
		if ((intmodel2 == 0 || intkomponen2 == 0 || vcartikel2 == '' || vcpo2 == '') && ((intpasang2 > 0) || (intreject2 > 0))) {
			swal({
					type: 'error',
					title: 'Model, Komponen, artikel, dan PO ke-2 Harus Diisi !!'
				});
			return false;
		}

		if (intmodel2 > 0 ||  intkomponen2 > 0 || vcartikel2 != '' || vcpo2 != '') {
            //lama
		...
		// model 3
		if ((intmodel3 > 0 || intkomponen3 > 0 || vcartikel3 != '' || vcpo3 != '') && (intpasang3 == '' || intpasang3 == 0 || intpasang3 < 0)) {
			swal({
					type: 'error',
		...
		if ((intmodel3 == 0 || intkomponen3 == 0 || vcartikel3 == '' || vcpo3 == '') && ((intpasang3 > 0) || (intreject3 > 0))) {
			swal({
					type: 'error',
					title: 'Model,Komponen, Artikel dan PO ke-3 Harus Diisii !!'
				});
			return false;
		}

		if (intmodel3 > 0 ||  intkomponen3 > 0 || vcartikel3 != '' || vcpo3 != '') {
            //lama
		...
		// Model 4 
		if ((intmodel4 > 0 || intkomponen4 > 0 || vcartikel4 != '' || vcpo4 != '') && (intpasang4 == '' || intpasang4 == 0 || intpasang4 < 0)) {
			swal({
					type: 'error',
		...
		if ((intmodel4 == 0 || intkomponen4 == 0 || vcartikel4 == '' || vcpo4 == '') && ((intpasang4 > 0) || (intreject4 > 0))) {
			swal({
					type: 'error',
					title: 'Model,Komponen, Artikel dan PO ke-4 Harus Diisi !!'
				});
			return false;
		}

		if (intmodel4 > 0 ||  intkomponen4 > 0 || vcartikel4 != '' || vcpo4 != '') {
            //lama
	...
	function saveoutput(_sop1,_sop2,_sop3,_sop4){
		...
		.done(function( data ) {
			...
			for (var i = 0; i < dataoutput.length; i++) {
				...
				_html += '<td>' + dataoutput[i].vcartikel + '</td>';
				_html += '<td>' + dataoutput[i].vcpo + '</td>';
			...
			$('#vcartikel1').select2().select2('val', '');
			...
			$('#vcartikel2').select2().select2('val', '');
			...
			$('#vcartikel3').select2().select2('val', '');
			...
			$('#vcartikel4').select2().select2('val', '');
	...
	$('#intmodel1').change(function(){
		...
		var base_url   = '<?=base_url("operator")?>';
		$.ajax({
			url: base_url + '/getkomponen_ajax/' + _intgedung + '/' + intid,
			method: "GET"
		})
		.done(function( data ) {
			var jsonData = JSON.parse(data);
			var html = '<option data-nama="" value="0">-Komponen-</option>';
			for (var i = 0; i < jsonData.length; i++) {
	...
	$('#intkomponen1').change(function(){
		...
		$.ajax({
			url: base_url + '/getartikel_ajax/' + _intgedung + '/' + intmodel + '/' + intkomponen,
			method: "GET"
		})
		.done(function( data ) {
			var jsonData = JSON.parse(data);
			var html = '<option value="">-Artikel-</option>';
			for (var i = 0; i < jsonData.length; i++) {
				html += '<option value="' + jsonData[i].vcartikel + '">' + jsonData[i].vcartikel + '</option>'
			}

			$('#vcartikel1').html(html)
		})
		.fail(function( jqXHR, statusText ) {
			alert( "Request failed: " + jqXHR.status );
		});
	...
	$('#vcartikel1').change(function(){
		var _session    = JSON.parse(localStorage.getItem('session'));
		var _intgedung  = _session.intgedungop;
		var intmodel    = $("#intmodel1").val();
		var intkomponen = $("#intkomponen1").val();
		var vcartikel   = $(this).val();
		var base_url    = '<?=base_url("operator")?>';
		
		$.ajax({
			url: base_url + '/getpo_ajax/' + _intgedung + '/' + intmodel + '/' + intkomponen + '/' + vcartikel,
			method: "GET"
		})
		.done(function( data ) {
			var jsonData = JSON.parse(data);
			var html = '<option value="">-- PO --</option>';
			for (var i = 0; i < jsonData.length; i++) {
