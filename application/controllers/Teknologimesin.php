...
class Teknologimesin extends MY_Controller {

    function __construct(){
        parent::__construct();
        $this->load->model('TeknologimesinModel');
        $this->model = $this->TeknologimesinModel;
    }
    ...
    function add(){
        ...
        $data['action']          = 'Add';
        $data['controller']      = $this->controller;
        $data['listprosesgroup'] = $this->modelapp->getdatalist('m_prosesgroup_sme2');
    ...
    function edit($intid){
        ...
        $data = array(
                    ...
                    'intprosesgroup'    => $resultData[0]->intprosesgroup,
                    'intupdate' => $this->session->intid,
                    'dtupdate'  => date('Y-m-d H:i:s')
                );
