...
class Output extends MY_Controller { 
    ...
    function exportexcelnew(){
        ...
        foreach ($datamesin as $mesin) {
            ...
            $excel->setActiveSheetIndex($loop)->setCellValue('J3', "Start");
            $excel->setActiveSheetIndex($loop)->setCellValue('K3', "Finish");
            $excel->setActiveSheetIndex($loop)->setCellValue('L3', "Duration");
            $excel->setActiveSheetIndex($loop)->setCellValue('M3', "Actual");
            $excel->setActiveSheetIndex($loop)->setCellValue('N3', "Reject");
            $excel->setActiveSheetIndex($loop)->setCellValue('O3', "Operator");
            $excel->setActiveSheetIndex($loop)->setCellValue('P3', "Leader");
            $excel->setActiveSheetIndex($loop)->setCellValue('Q3', "Shift");
            ...
            foreach ($data as $dataset) {
                ...
                $excel->setActiveSheetIndex($loop)->setCellValue('J'.$numrow, $dataset->dtmulai);
                $excel->setActiveSheetIndex($loop)->setCellValue('K'.$numrow, $dataset->dtselesai);
                $excel->setActiveSheetIndex($loop)->setCellValue('L'.$numrow, $dataset->decdurasi);
                $excel->setActiveSheetIndex($loop)->setCellValue('M'.$numrow, $dataset->intpasang);
                $excel->setActiveSheetIndex($loop)->setCellValue('N'.$numrow, $dataset->intreject);
                $excel->setActiveSheetIndex($loop)->setCellValue('O'.$numrow, $dataset->vcoperator);
                $excel->setActiveSheetIndex($loop)->setCellValue('P'.$numrow, $dataset->vcleader);
                $excel->setActiveSheetIndex($loop)->setCellValue('Q'.$numrow, $dataset->vcshift);
