...
class Downtime_autocutting extends MY_Controller { 
    ...
    function exportexcel(){
        ...
        if ($intshift == 0) {
                $date1 = date( "Y-m-d 07:00:00", strtotime( $from) );
                $date2 = date( "Y-m-d 06:59:59", strtotime( $to . " + 1 day" ) );
                $data   = $this->model->getdata($this->table,$intmesin,$date1,$date2, $intdowntime);

        } else if ($intshift > 0) {
                $date1 = date( "Y-m-d 07:00:00", strtotime( $from) );
                $date2 = date( "Y-m-d 06:59:59", strtotime( $to . " + 1 day" ) );
                $data   = $this->model->getdatapershift($this->table,$intmesin,$date1,$date2,$intshift, $intdowntime);
        }
