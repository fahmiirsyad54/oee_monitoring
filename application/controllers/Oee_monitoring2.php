...
class Oee_monitoring2 extends CI_Controller {

    function __construct(){
        parent::__construct();
        date_default_timezone_set('Asia/Jakarta');
        $this->load->model('AppModel');
        $this->load->model('OEE_monitoring2Model');
        $this->model = $this->OEE_monitoring2Model;
    ...
    function index(){
        redirect(base_url('oee_monitoring2/dashboard'));
    }

    function dashboard($datest='',$datefs=''){
        $this->load->view('monitoring2_view/index');
    }
    ...
    function dashboard_ajax($datest='',$datefs=''){
        ...
        $this->load->view('monitoring2_view/index',$data);
    }
