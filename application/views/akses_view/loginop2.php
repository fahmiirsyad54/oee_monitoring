...
<div class="login-box">
  <div class="login-logo">
    <a href="<?=BASE_URL_PATH?>assets/index2.html"><b>TPM</b>System</a> <br> Laser Monitoring
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="<?=base_url('akses/authop2')?>" method="post">
      <?php if ($errorLogin) { ?>
...
<script>
  function validasi(){
    ...
    var base_url = '<?=base_url('akses/validasiop2')?>';
    ...
    .done(function( data ) {
      ...
      if (jsonData.status) {
        ...
        if (timeCounting == null) {
          // Set Start Time
          var timeCounting = { 'dtstart': jsonData.dttime, 'counttipe': 1, 'intshift': jsonData.intshift, 'dttanggal':jsonData.dttanggal};
        ...
        window.location = "<?=base_url('operator2')?>";
      } else {
        swal({
          type: 'error',
