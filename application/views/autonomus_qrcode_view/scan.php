...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="<?=BASE_URL_PATH_HTTPS?>assets/bower_components/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?=BASE_URL_PATH_HTTPS?>assets/bower_components/font-awesome/css/font-awesome.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?=BASE_URL_PATH_HTTPS?>assets/dist/css/AdminLTE.min.css">
</head>
<body>
<style>
    canvas {
...
<script type="module">
    import QrScanner from "<?=BASE_URL_PATH_HTTPS?>auditam/scanqr/qr-scanner.min.js";
    QrScanner.WORKER_PATH = '<?=BASE_URL_PATH_HTTPS?>auditam/scanqr/qr-scanner-worker.min.js';
    ...
    function setResult(label, result) {
        ...
        window.location.href = 'http://' + window.location.hostname + '/tpmsystem2/autonomus/add_mobile/'+result;
    }
