	...
	<div class="modal-dialog modal-sm">
		...
		<div class="modal-content">
			<div class="modal-body">
				<button onclick="exportexcel()" class="btn btn-success btn-block">Actual</button>
				<button onclick="exportexcel2()" class="btn btn-success btn-block">Monitoring</button>
			</div>
		</div>
	</div>
</div>
<script type="text/javascript">
	...
	function exportexcel2(){
		...
		var intmesin  = $('#intmesin').val();
		var intshift  = $('#intshift').val();
		window.open(base_url + '/exportexcel2?from=' + from + '&to=' + to + '&intgedung=' + intgedung + '&intmesin=' + intmesin + '&intshift=' + intshift);
	}
