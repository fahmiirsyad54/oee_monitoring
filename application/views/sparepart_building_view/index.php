		...
		<div class="box">
			...
			<div class="box-body">
				<div class="row margin-bottom-10">
					...
					<div class="col-md-2">
						<select class="form-control select2" name="intgedung" id="intgedung" style="width: 100%;">
							<option selected="selected" value="0">-- All Building --</option>
							<?php
					...
					<div class="col-md-2">
						<select class="form-control select2" name="intsparepart" id="intsparepart" style="width: 100%;">
							<option selected="selected" value="0">-- All Sparepart --</option>
							<?php
