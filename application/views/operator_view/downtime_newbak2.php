...
<script type="text/javascript">
	...
	function simpanoutput(dtselesai){
		...
		// Model 2
		if ((intmodel2 > 0 || intkomponen2 > 0) && (intpasang2 == '' || intpasang2 == 0 || intpasang2 < 0 || vcnomorpo2 == '' || vcartikel2 == '')) {
			swal({
					type: 'error',
					title: 'Jumlah Komponen, Nomor PO, dan Artikel ke-2 Harus Diisi !!'
				});
			return false;
		}
		...
		// model 3
		if ((intmodel3 > 0 || intkomponen3 > 0) && (intpasang3 == '' || intpasang3 == 0 || intpasang3 < 0 || vcnomorpo3 == '' || vcartikel3 == '')) {
			swal({
					type: 'error',
					title: 'Jumlah Komponen, Nomor PO, dan Artikel ke-3 Harus Diisi !!'
				});
			return false;
		}
		...
		// Model 4 
		if ((intmodel4 > 0 || intkomponen4 > 0) && (intpasang4 == '' || intpasang4 == 0 || intpasang4 < 0 || vcnomorpo4 == '' || vcartikel4 == '')) {
			swal({
					type: 'error',
					title: 'Jumlah Komponen, Nomor PO, dan Artikel ke-4 Harus Diisi !!'
				});
			return false;
		}
