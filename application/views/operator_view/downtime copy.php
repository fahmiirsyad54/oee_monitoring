		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<!-- <div class="col-md-2">
						<div class="form-group">
							<select name="vcpo" class="form-control" id="vcpo1">
								<option data-nama="" value="0">-- Pilih PO --</option>
							</select>
							<input type="hidden" name="intqty" id="intqty1" class="form-control" disabled="">
							<input type="hidden" name="jumlahpasang" id="jumlahpasang1" class="form-control" disabled="">
						</div>
					</div> -->

					<div class="col-md-1">
						<div class="form-group">
							<input type="text" name="vcpo" id="vcpo1" class="form-control" placeholder="PO">
						</div>
					</div>

					<div class="col-md-1">
						<div class="form-group">
							<input type="checkbox" name="cekpo" id="cekpo1" style="display:inline-block; position:relative; width:50px; height:25px; "> 
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<select name="vcpo" class="form-control" id="vcpo2">
								<option data-nama="" value="0">-- Pilih PO --</option>
							</select>
							<input type="hidden" name="intqty" id="intqty2" class="form-control">
							<input type="hidden" name="jumlahpasang" id="jumlahpasang2" class="form-control">
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<select name="vcpo" class="form-control" id="vcpo3">
								<option data-nama="" value="0">-- Pilih PO --</option>
							</select>
							<input type="hidden" name="intqty" id="intqty3" class="form-control">
							<input type="hidden" name="jumlahpasang" id="jumlahpasang3" class="form-control">
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<select name="vcpo" class="form-control" id="vcpo4">
								<option data-nama="" value="0">-- Pilih PO --</option>
							</select>
							<input type="hidden" name="intqty" id="intqty4" class="form-control">
							<input type="hidden" name="jumlahpasang" id="jumlahpasang4" class="form-control">
						</div>
					</div>
...
<script type="text/javascript">
	...
	function simpanoutput(dtselesai){
		...
		var jumlahpasang = $('#jumlahpasang1').val();
		...
		var intqty2       = $('#intqty2').val();
		var jumlahpasang2 = $('#jumlahpasang2').val();
		...
		var intqty3       = $('#intqty3').val();
		var jumlahpasang3 = $('#jumlahpasang3').val();
		...
		var intqty4       = $('#intqty4').val();
		var jumlahpasang4 = $('#jumlahpasang4').val();

		var totalpasang = parseInt(jumlahpasang) + parseInt(intpasang);
		if (totalpasang > intqty) {
			swal({
					type: 'warning',
					title: 'Total potong 1 melebihi target, periksa total potong anda !'
				});
			return false;
		}

		var totalpasang2 = parseInt(jumlahpasang2) + parseInt(intpasang2);
		if (totalpasang2 > intqty2) {
			swal({
					type: 'warning',
					title: 'Total potong 2 melebihi target, periksa total potong anda !'
				});
			return false;
		}

		var totalpasang3 = parseInt(jumlahpasang3) + parseInt(intpasang3);
		if (totalpasang3 > intqty3) {
			swal({
					type: 'warning',
					title: 'Total potong 3 melebihi target, periksa total potong anda !'
				});
			return false;
		}

		var totalpasang4 = parseInt(jumlahpasang4) + parseInt(intpasang4);
		if (totalpasang4 > intqty4) {
			swal({
					type: 'warning',
					title: 'Total potong 4 melebihi target, periksa total potong anda !'
				});
			return false;
		}
		...
		// var _max1       = _target1 + Math.ceil(_target1 * 0.2);
		// var _min1       = _target1 - Math.ceil(_target1 * 0.2);
		...
		// Model 2
		if ((intmodel2 > 0 || intkomponen2 > 0 || vcpo2 > 0 || intremark2 > 0) && (intpasang2 == '' || intpasang2 == 0 || intpasang2 < 0)) {
			swal({
					type: 'error',
		...
		if ((intmodel2 == 0 || intkomponen2 == 0 || vcpo2 == 0 || intremark2 == 0) && ((intpasang2 > 0) || (intreject2 > 0))) {
			swal({
					type: 'error',
		...
		if (intmodel2 > 0 ||  intkomponen2 > 0 || vcpo2 != 0 || intremark2 > 0) {
            //lama
            ...
            // var _max1          = _target1 + Math.ceil(_target1 * 0.2);
            // var _min1          = _target1 - Math.ceil(_target1 * 0.2);
            // var _max2          = _target2 + Math.ceil(_target2 * 0.2);
            // var _min2          = _target2 - Math.ceil(_target2 * 0.2);
		...
		// model 3
		if ((intmodel3 > 0 || intkomponen3 > 0 || vcpo3 > 0 || intremark3 > 0) && (intpasang3 == '' || intpasang3 == 0 || intpasang3 < 0)) {
			swal({
					type: 'error',
		...
		if ((intmodel3 == 0 || intkomponen3 == 0 || vcpo3 == 0 ||  intremark3 == 0) && ((intpasang3 > 0) || (intreject3 > 0))) {
			swal({
					type: 'error',
		...
		if (intmodel3 > 0 ||  intkomponen3 > 0 || vcpo3 != 0 || intremark3 > 0) {
            //lama
            ...
            // var _max2          = _target2 + Math.ceil(_target2 * 0.2);
            // var _min2          = _target2 - Math.ceil(_target2 * 0.2);
            // var _max3          = _target3 + Math.ceil(_target3 * 0.2);
            // var _min3          = _target3 - Math.ceil(_target3 * 0.2);
		...
		// Model 4 
		if ((intmodel4 > 0 || intkomponen4 > 0 || vcpo4 != 0 || intremark4 > 0) && (intpasang4 == '' || intpasang4 == 0 || intpasang4 < 0)) {
			swal({
					type: 'error',
		...
		if ((intmodel4 == 0 || intkomponen4 == 0 || vcpo4 == 0 || intremark4 == 0) && ((intpasang4 > 0) || (intreject4 > 0))) {
			swal({
					type: 'error',
		...
		if (intmodel4 > 0 ||  intkomponen4 > 0 || intremark4 > 0) {
            ...
            // var _max3          = _target3 + Math.ceil(_target3 * 0.2);
            // var _min3          = _target3 - Math.ceil(_target3 * 0.2);
            // var _max4          = _target4 + Math.ceil(_target4 * 0.2);
            // var _min4          = _target4 - Math.ceil(_target4 * 0.2);
	...
	function saveoutput(_sop1,_sop2,_sop3,_sop4){
		...
		.done(function( data ) {
			...
			$('#dtmulaioutput').val('');
			$('#dtselesaioutput').val('');
			$('#intmodel1').select2().select2('val', '0');
			$('#intkomponen1').select2().select2('val', '0');
			$('#vcpo1').select2().select2('val', '0');
			$('#intremark1').select2().select2('val', '0');
			$('#intqty1').val('');
			$('#jumlahpasang1').val('');
			...
			$('#dtmulaioutput').val('');
			$('#dtselesaioutput').val('');
			$('#intmodel2').select2().select2('val', '0');
			$('#intkomponen2').select2().select2('val', '0');
			$('#vcpo2').select2().select2('val', '0');
			$('#intremark2').select2().select2('val', '0');
			$('#intqty2').val('');
			$('#jumlahpasang2').val('');
			...
			$('#dtmulaioutput').val('');
			$('#dtselesaioutput').val('');
			$('#intmodel3').select2().select2('val', '0');
			$('#intkomponen3').select2().select2('val', '0');
			$('#vcpo3').select2().select2('val', '0');
			$('#intremark3').select2().select2('val', '0');
			$('#intqty3').val('');
			$('#jumlahpasang3').val('');
			...
			$('#dtmulaioutput').val('');
			$('#dtselesaioutput').val('');
			$('#intmodel4').select2().select2('val', '0');
			$('#intkomponen4').select2().select2('val', '0');
			$('#vcpo4').select2().select2('val', '0');
			$('#intremark4').select2().select2('val', '0');
			$('#intqty4').val('');
			$('#jumlahpasang4').val('');
	...
	$('#intmodel1').change(function(){
		...
		.done(function( data ) {
			...
			for (var i = 0; i < listkomponen.length; i++) {
				html += '<option data-ct="' + listkomponen[i].deccycle_time + '" data-layer="' + listkomponen[i].intlayer + '" data-intid="' + listkomponen[i].intid + '" value="' + listkomponen[i].intkomponen + '">' + listkomponen[i].vckomponen + '</option>'
			}
			$('#intkomponen1').html(html);

			var listpo = jsonData.listpo;
			var pohtml = '<option data-nama="" value="0">-- Pilih PO --</option>';
			for (var i = 0; i < listpo.length; i++) {
				pohtml += '<option data-qty="' + listpo[i].intqty + '" data-intid="' + listpo[i].intid + '" value="' + listpo[i].vcpo + '">' + listpo[i].vcpo.substring(listpo[i].vcpo.length - 4, listpo[i].vcpo.length) + '</option>'
			}
			$('#vcpo1').html(pohtml);
		})
		.fail(function( jqXHR, statusText ) {
