						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group">
									...
									<input type="hidden" name="jumlahpasang" id="jumlahpasang1" class="form-control">
									<input type="hidden" name="poasli" id="poasli1" class="form-control">
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group">
									...
									<input type="hidden" name="poasli" id="poasli2" class="form-control">
								</div>
							</div>
							<div class="col-md-2 col-md-pull-2">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group">
									...
									<input type="hidden" name="poasli" id="poasli3" class="form-control">
								</div>
							</div>
							<div class="col-md-2 col-md-pull-2">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group">
									...
									<input type="hidden" name="poasli" id="poasli4" class="form-control">
								</div>
							</div>
							<div class="col-md-2 col-md-pull-2">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group">
									...
									<input type="hidden" name="jumlahpasang" id="jumlahpasang5" class="form-control">
									<input type="hidden" name="poasli" id="poasli5" class="form-control">
								</div>
							</div>
							<div class="col-md-2 col-md-pull-2">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-10">
								<div class="form-group">
									...
									<input type="hidden" name="jumlahpasang" id="jumlahpasang6" class="form-control">
									<input type="hidden" name="poasli" id="poasli6" class="form-control">
								</div>
							</div>
							<div class="col-md-2 col-md-pull-2">
								<div class="form-group">
...
<script type="text/javascript">
	...
	function canceloutput() {
		...
		$('#dtmulaioutput').val('');
		$('#dtselesaioutput').val('');
		$('#intmodel5').select2().select2('val', '');
		$('#intkomponen5').select2().select2('val', '');
		...
		$('#dtmulaioutput').val('');
		$('#dtselesaioutput').val('');
		$('#intmodel6').select2().select2('val', '');
		$('#intkomponen6').select2().select2('val', '');
	...
	function simpanoutput(dtselesai){
		...
		var intqty5       = $('#intqty5').val();
		var jumlahpasang5 = $('#jumlahpasang5').val();
		...
		var intqty6       = $('#intqty6').val();
		var jumlahpasang6 = $('#jumlahpasang6').val();
	...
	function saveoutput(_sop1,_sop2,_sop3,_sop4,_sop5,_sop6){
		...
		.done(function( data ) {
			...
			$('#dtmulaioutput').val('');
			$('#dtselesaioutput').val('');
			$('#intmodel5').select2().select2('val', '0');
			$('#intkomponen5').select2().select2('val', '0');
			$('#intremark5').select2().select2('val', '0');
			$('#intqty5').val('');
			$('#jumlahpasang5').val('');
			$('#poasli5').val('');
			document.getElementById("intpasang5").disabled = true;
			...
			$('#dtmulaioutput').val('');
			$('#dtselesaioutput').val('');
			$('#intmodel6').select2().select2('val', '0');
			$('#intkomponen6').select2().select2('val', '0');
			$('#intremark6').select2().select2('val', '0');
			$('#intqty6').val('');
			$('#jumlahpasang6').val('');
			$('#poasli6').val('');
			document.getElementById("intpasang6").disabled = true;
		...
		if ($(this).is(':checked')) {
			...
			if (vcpo == 0 || vcpo == '') {
				...
				if (intkomponen == 0) {
					...
					$.ajax({
						url: base_url + '/getstatuspo/' + intmodel + '/' + intkomponen + '/' + vcpo,
						method: "GET"
					})
					.done(function( data ) {
						var jsonData = JSON.parse(data);
	...
	$('#cekpo5').change(function(){
		if ($(this).is(':checked')) {
			...
			var intkomponen = $('#intkomponen5').val();
			var base_url    = '<?=base_url("operator")?>';
			if (vcpo == 0 || vcpo == '') {
				document.getElementById("cekpo5").checked = false;
				swal({
				...
				if (intkomponen == 0) {
					...
					.done(function( data ) {
						...
						if (jsonData.intstatus == 0) {
							...
							$('#poasli5').val(jsonData.poasli);
							$('#intqty5').val(jsonData.intqty);
							$('#jumlahpasang5').val(jsonData.jumlahpasang);
	...
	$('#cekpo6').change(function(){
		if ($(this).is(':checked')) {
			...
			var intkomponen = $('#intkomponen6').val();
			var base_url    = '<?=base_url("operator")?>';
			if (vcpo == 0 || vcpo == '') {
				document.getElementById("cekpo6").checked = false;
				swal({
				...
				if (intkomponen == 0) {
					...
					.done(function( data ) {
						...
						if (jsonData.intstatus == 0) {
							...
							$('#poasli6').val(jsonData.poasli);
							$('#intqty6').val(jsonData.intqty);
							$('#jumlahpasang6').val(jsonData.jumlahpasang);
