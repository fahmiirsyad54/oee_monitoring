  ...
  <div class="col-md-12">
    <div class="alert alert-info" style="border-radius: 0px; background-color: #b7fd35 !important; border-color: #b7fd35 !important">
      ...
      <div class="pull-right">
        <a href="<?=base_url('oee_monitoring2/buildingall_/'.$intgedung)?>" style="padding-right: 20px; color: #000">Home</a>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-2">
      <div class="form-group">
        <div class="btn-group" role="group">
          <a href="<?=base_url('oee_monitoring2/machine/'.$intmesin)?>" class="btn <?=$btnreal?>">Real Time</a>
          <a href="<?=base_url('oee_monitoring2/machine/'.$intmesin.'/'.date('Y-m-d',strtotime($datest)).'/'.date('Y-m-d',strtotime($datefs)))?>" class="btn <?=$btnhistory?>">History Time</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-5">
      ...
      <a href="<?=base_url('oee_monitoring2/buildingall_/'.$intgedung)?>" class="btn btn-default"><i class="fa fa-home"></i></a>
...
<script type="text/javascript">
  ...
  function showoee(){
    ...
    window.location.href = base_url + 'oee_monitoring2/machine/'+ intmesin + '/' + convertdate(_date1) + '/' + convertdate(_date2);
  }
</script>