  ...
  <div class="col-md-12">
    <div class="alert alert-info" style="border-radius: 0px; background-color: #b7fd35 !important; border-color: #b7fd35 !important">
      ...
      <div class="pull-right" style="color: #000">
        <a href="<?=base_url('oee_monitoring2')?>" style="padding-right: 20px; color: #000">Home</a>
        <a href="<?=base_url('oee_monitoring2/building/'.$intgedung)?>" style="padding-right: 20px; color: #000">Building</a>
