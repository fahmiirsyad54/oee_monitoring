...
<div class="container-fluid">
    ...
    <div class="col-md-2">
      <div class="form-group">
        <div class="btn-group" role="group">
          <a href="<?=base_url('oee_monitoring2/building_/'.$intgedung)?>" class="btn <?=$btnreal?>">Real Time</a>
          <a href="<?=base_url('oee_monitoring2/building_/'.$intgedung.'/'.date('Y-m-d',strtotime($datest)).'/'.date('Y-m-d',strtotime($datefs)))?>" class="btn <?=$btnhistory?>">History Time</a>
        </div>
      </div>
    </div>
  ...
  <hr style="border: 3px solid #000000; margin-top: -30px; margin-bottom: 10px;">
  <div class="row">
    <?php
    ...
    <a href="<?=base_url('oee_monitoring2/machine_/'.$intgedung.'/') . $mesin['intmesin']?>">
      <div class="col-md-3">
        <div class="box box-solid" style="background-color: #b3b3b3">
          <div class="box-header">
            <h3 class="box-title" style="color: #000000"><?='Laser ' . substr($mesin['vcmesin'], -3) . ' - ' . $mesin['vckodemesin']?></h3>
  ...
  <!-- <div class="row <?=$hideoee2?>">
    ...
    <div class="col-md-6">
      <div class="row">
        <div class="col-md-12">
          <h4 class="pull-right"><?=$dtcell['vccell']?></h4>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-solid" style="background-color: #ffc266">
            <div class="box-header">
              <h3 class="box-title text-warning" style="color: #000000; font-weight: bold;">OEE</h3>
            </div>
            <div class="box-body text-center">
        ...
        <div class="col-md-4">
          <div class="box box-solid" style="background-color: #000080">
            <div class="box-header">
              <h3 class="box-title text-warning" style="color: #FFFFFF; font-weight: bold;">Availability Factor</h3>
            </div>
            <div class="box-body text-center">
        ...
        <div class="col-md-4">
          <div class="box box-solid" style="background-color: #000080">
            <div class="box-header">
              <h3 class="box-title text-warning" style="color: #FFFFFF; font-weight: bold;">Performance Factor</h3>
            </div>
            <div class="box-body text-center">
        ...
        <div class="col-md-4">
          <div class="box box-solid" style="background-color: #000080">
            <div class="box-header">
              <h3 class="box-title text-warning" style="color: #FFFFFF; font-weight: bold;">Quality Factor</h3>
            </div>
            <div class="box-body text-center">
        ...
        ?>
          <a href="<?=base_url('oee_monitoring2/machine_/'.$intgedung.'/') . $mesin['intmesin']?>">
            <div class="col-md-4">
              <div class="box box-solid" style="background-color: #b3b3b3">
                <div class="box-header">
                  <h3 class="box-title text-warning" style="color: #000000; font-weight: bold;"><?='Laser ' . substr($mesin['vcmesin'], -4) . ' - ' . $mesin['vckodemesin']?></h3>
                  <span class="pull-right label label-<?=($mesin['statusmesin'] == 'On') ? 'success' : 'danger'?>"><?=$mesin['statusmesin']?></span>
                </div>
                <div class="box-body text-center">
                ...
                <div class="box-header" style="color: #000000">
                  ...
                  <div class="progress xs">
                    <div class="progress-bar progress-bar-primary" style="width: <?=$mesin['avgoee']?>%; background-color:<?=$bar?>" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                    </div>
                  </div>
                </div>
              </div>
...
<script type="text/javascript">
  ...
  function showoee(){
    ...
    window.location.href = base_url + 'oee_monitoring2/building_/'+ intgedung + '/' + convertdate(_date1) + '/' + convertdate(_date2);
  }
