  ...
  <div class="col-md-12">
    <div class="alert alert-info" style="border-radius: 0px; background-color: #b7fd35 !important; border-color: #b7fd35 !important">
      ...
      <div class="pull-right">
        ...
        <a href="<?=base_url('oee_monitoring/buildingall/' .$intgedung)?>" style="padding-right: 20px; color: #000">OEE Combine</a>
...
<div class="container-fluid">
    ...
    <div class="col-md-2">
      <div class="form-group">
        <div class="btn-group" role="group">
          <a href="<?=base_url('oee_monitoring2/building/'.$intgedung)?>" class="btn <?=$btnreal?>">Real Time</a>
          <a href="<?=base_url('oee_monitoring2/building/'.$intgedung.'/'.date('Y-m-d',strtotime($datest)).'/'.date('Y-m-d',strtotime($datefs)))?>" class="btn <?=$btnhistory?>">History Time</a>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <a href="<?=base_url('oee_monitoring2/machine/') . $mesin['intmesin']?>">
      <div class="col-md-3">
          ...
          ?>
            <a href="<?=base_url('oee_monitoring2/machine/') . $mesin['intmesin']?>">
              <div class="col-md-4">
                <div class="box box-solid" style="background-color: #b3b3b3">
                  <div class="box-header">
                    <h3 class="box-title" style="color: #000000; font-weight: bold;"><?='Laser ' . substr($mesin['vcmesin'], -4) . ' - ' . $mesin['vckodemesin']?></h3>
                    <span class="pull-right label label-<?=($mesin['statusmesin'] == 'On') ? 'success' : 'danger'?>"><?=$mesin['statusmesin']?></span>
                  </div>
                  <div class="box-body text-center">
...
<script type="text/javascript">
  ...
  function showoee(){
    ...
    window.location.href = base_url + 'oee_monitoring2/building/'+ intgedung + '/' + convertdate(_date1) + '/' + convertdate(_date2);
  }
