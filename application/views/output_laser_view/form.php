						...
						<div class="row control-group">
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="decct[]" id="decct" class="form-control" value="<?=$decct?>">
									<input type="text" name="intlayer[]" id="intlayer" class="form-control" value="<?=$intlayer?>" >
								</div>
							</div>
						...
						<div class="row control-group">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="decct[]" id="decct" class="form-control" value="<?=$combine->decct?>">
									<input type="text" name="intlayer[]" id="intlayer" class="form-control" value="<?=$combine->intlayer?>">
								</div>
							</div>
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<select name="intremark[]" class="form-control" id="intremark">
										...
										<?php
											foreach ($listremark as $opt) {
												$selected = ($combine->intremark == $opt->intid) ? 'selected' : '' ;
										?>
										<option <?=$selected?> data-nama="<?=$opt->vcnama?>" value="<?=$opt->intid?>"><?=$opt->vcnama?></option>
										<?php
											}
...
<script type="text/javascript">
	...
	$('#intmodel').change(function(){
		var intid    = $(this).val();
		var base_url = '<?=base_url("output_laser")?>';
		$.ajax({
