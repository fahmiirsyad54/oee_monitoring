  ...
  <div class="col-md-12">
    <div class="alert alert-info" style="border-radius: 0px; background-color: #b7fd35 !important; border-color: #b7fd35 !important">
      ...
      <div class="pull-right">
        <a href="<?=base_url('oee_monitoring/building_/'.$intgedung)?>" style="padding-right: 20px; color: #000">Home</a>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-2">
      <div class="form-group">
        <div class="btn-group" role="group">
          <a href="<?=base_url('oee_monitoring/building_/'.$intgedung)?>" class="btn <?=$btnreal?>">Real Time</a>
          <a href="<?=base_url('oee_monitoring/building_/'.$intgedung.'/'.date('Y-m-d',strtotime($datest)).'/'.date('Y-m-d',strtotime($datefs)))?>" class="btn <?=$btnhistory?>">History Time</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
      ...
      <a href="<?=base_url('oee_monitoring/building_/'.$intgedung)?>" class="btn btn-default"><i class="fa fa-home"></i></a>
        ...
        ?>
          <a href="<?=base_url('oee_monitoring/machine_/'.$intgedung.'/') . $mesin['intmesin']?>">
            <div class="col-md-4">
              <div class="box box-solid" style="background-color: #b3b3b3">
                <div class="box-header">
                  <h3 class="box-title text-warning" style="color: #000000; font-weight: bold;"><?='Comelz ' . substr($mesin['vcmesin'], -4) . ' - ' . $mesin['vckodemesin']?></h3>
                  <span class="pull-right label label-<?=($mesin['statusmesin'] == 'On') ? 'success' : 'danger'?>"><?=$mesin['statusmesin']?></span>
                </div>
                <div class="box-body text-center">
                  <input type="text" class="knob" data-thickness="0.2" data-angleArc="250" data-angleOffset="-125" value="<?=$mesin['avgoee']?>%" data-width="120" data-height="120" data-fgColor="<?=$warna?>" readonly>
