...
?>
  ...
  <div class="row <?=$hideoee1?>">
    ...
    <a href="<?=base_url('oee_monitoring/machine_/'.$intgedung.'/') . encrypt_url($mesin['intmesin'])?>">
      <div class="col-md-3">
        ...
        ?>
          <a href="<?=base_url('oee_monitoring/machine_/'.$intgedung.'/') . encrypt_url($mesin['intmesin'])?>">
            <div class="col-md-4">
              <div class="box box-solid" style="background-color: #b3b3b3">
                <div class="box-header">
                  <h3 class="box-title text-warning" style="color: #000000; font-weight: bold;"><?=$namamesin . ' ' . substr($mesin['vcmesin'], -4) . ' - ' . $mesin['vckodemesin']?></h3>
                  <span class="pull-right label label-<?=($mesin['statusmesin'] == 'On') ? 'success' : 'danger'?>"><?=$mesin['statusmesin']?></span>
                </div>
                <div class="box-body text-center">
                  <span class="pull-left label label-success"><?=$mesin['statuskalibrasi']?></span>
