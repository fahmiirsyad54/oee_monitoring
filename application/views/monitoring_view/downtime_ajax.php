                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align:center"><?=$datadowntime['jmldurasi']?></td>
...
<script type="text/javascript">
  ...
  function search(){
    ...
    window.location.replace(base_url + "oee_monitoring/downtime/" + intgedung + "/" + convertdate(from) + "/" + convertdate(to) + "/" + intshift);
...
<script type="text/javascript">
  ...
  $(function (){
    ...
    // topdowntime chart
    $.ajax({
        url: base_url + '/grafikdowntime/' + intgedung + '/' + convertdate(from) + '/' + convertdate(to) + '/' + intshift,
        method: "GET"
    })
    .done(function( data ) {
        var result = JSON.parse(data);
        var grafik =  result.grafikdowntime;

        var vcdowntime = {};
        var jmldurasi = [];
        grafik.forEach(function(e) {
            jmldurasi.push(e.vcdowntime);
            vcdowntime[e.vcdowntime] = e.jmldurasi;
        })    
