...
<div class="container-fluid">
    ...
    <div class="col-md-2">
      <div class="form-group">
        <div class="btn-group" role="group">
          <a href="<?=base_url('oee_monitoring/buildingall/'.$intgedung)?>" class="btn <?=$btnreal?>">Real Time</a>
          <a href="<?=base_url('oee_monitoring/buildingall/'.$intgedung.'/'.date('Y-m-d',strtotime($datest)).'/'.date('Y-m-d',strtotime($datefs)))?>" class="btn <?=$btnhistory?>">History Time</a>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <a href="<?=base_url('oee_monitoring/building/') . $intgedung?>">
      <div class="col-md-6">
        <div class="row">
          <div class="col-md-12">
    ...
    <a href="<?=base_url('oee_monitoring2/building/') . $intgedung?>">
      <div class="col-md-6">
        <div class="row">
          <div class="col-md-12">
            <div class="box box-solid" style="background-color: #000000">
